...
class TestSafeMapAPI(unittest.TestCase):
    ...
    def test_06_ofuscacion_coordenadas(self):
        ...
        El cálculo de la grilla de longitud usa math.cos(latitud), NO math.cos(longitud).
        La función _snap_to_grid en main.py recibe lat=lat_raw cuando is_lat=False.
        """
        ...
        # Para latitud: 1 metro = 1/111_320 grados (independiente de la posición).
        deg_per_m_lat = 1 / 111_320
        step_lat = 100 * deg_per_m_lat
        expected_lat = round(lat_exacta / step_lat) * step_lat

        # Para longitud: el coseno depende de la LATITUD del punto, no de la longitud.
        deg_per_m_lng = 1 / (111_320 * math.cos(math.radians(lat_exacta)))
